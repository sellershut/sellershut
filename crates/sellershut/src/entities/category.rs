...
use sellershut_core::categories::Category as DbCategory;
use serde::{Deserialize, Serialize};
use tracing::instrument;
use url::Url;

#[derive(Debug, Deserialize, Serialize)]
pub struct LocalCategory(DbCategory);

impl From<DbCategory> for LocalCategory {
...
pub struct Category {
    #[serde(rename = "type")]
    kind: ObjectType,
    id: ObjectId<LocalCategory>,
    #[serde(deserialize_with = "deserialize_one_or_many")]
    pub to: Vec<Url>,
    content: LocalCategory,
}

#[tonic::async_trait]
impl Object for LocalCategory {
